            ...
            <div className="navbar bg-gray-900 shadow-sm">
                <div className="navbar-start">
                    <div className="dropdown">
                        <div tabIndex={0} role="button" className="btn bg-red-800 p-3 mr-4 lg:hidden">
                    ...
                    <Link  className="  rounded-full" href={'/'}><Image width='120' height='80' src='/logo2.image.png' alt="logo pic"></Image></Link>
                </div>
